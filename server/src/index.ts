    ...
    for (let arr of Arr) {
      ...
      for (let a of arr) {
        ...
        var thisDate =
          ...
          "/" +
          date.substring(8, 10);
        var diffYear = Math.abs(
          new Date(thisDate).getTime() - new Date(currentYear).getTime()
        );
        var diffWeek = Math.abs(
          new Date(thisDate).getTime() - new Date(currentWeek).getTime()
        );
        var diffMonth = Math.abs(
          new Date(thisDate).getTime() - new Date(currentMonth).getTime()
        );
